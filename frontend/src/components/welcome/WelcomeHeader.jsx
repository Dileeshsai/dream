  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-row items-center justify-between gap-2 md:gap-4 relative z-30">
         ...
         <div className="flex flex-row items-center gap-4 md:gap-6 min-w-fit justify-center md:justify-start">
           <div className="logo-container flex items-center justify-center rounded-xl border-2 border-blue-200/60 shadow-2xl" style={{padding:'10px 16px',minWidth:'fit-content'}}>
             <span 
               className="font-black text-white text-base md:text-lg lg:text-xl tracking-wider relative z-10 whitespace-nowrap"
               style={{
                 fontFamily: logoFont,
             ...
             <span className="brand-text font-extrabold text-xl md:text-2xl lg:text-3xl tracking-tight" style={{fontFamily:logoFont,letterSpacing:'-0.8px',lineHeight:'1.05',textTransform:'uppercase'}}>UNITY</span>
           </div>
        </div>
        {/* Desktop Nav & Auth */}
              ...
              <div className="flex flex-col gap-6 p-4 md:p-6 h-full overflow-y-auto">
                <div className="flex flex-row items-center gap-3 mb-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="brand-text font-semibold text-sm md:text-base leading-tight"></span>
                  </div>
                </div>
